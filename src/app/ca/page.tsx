        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-display font-bold text-gray-900 mb-6">
              ...
              <br />
              <span className="text-brand-600">for Canadian businesses.</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Based in Toronto, ON. We help Canadian startups and growing businesses build, fix, and launch software that works — fast.
            </p>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">
              Based in Toronto, ON • {offices.ca.phone} • {offices.ca.email}
            </p>
        ...
        <div className="container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" variant="secondary" asChild>
              <Link href="/contact?country=ca">Get Started Today</Link>
            </Button>
