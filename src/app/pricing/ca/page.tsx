...
import { pricingCA, creativePricingCA } from '@/data/pricing'
import { formatPrice } from '@/lib/utils'
import { CheckCircle, DollarSign, Clock, Package, Users, Brush, Type, Palette, Megaphone } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Canadian Pricing - BrightCode',
  description: 'Transparent pricing for Canadian businesses. Custom development, bug fixes, integrations, design, and creative services in CAD.',
  openGraph: {
    title: 'Canadian Pricing - BrightCode',
    description: 'Transparent pricing for Canadian businesses. Custom development, bug fixes, integrations, design, and creative services in CAD.',
  },
      ...
      <section className="py-20 bg-gradient-to-br from-brand-50 to-blue-50">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <Badge variant="secondary" className="mb-4">Canadian Pricing</Badge>
            <h1 className="text-5xl md:text-6xl font-display font-bold text-gray-900 mb-6">
              Transparent pricing
              <br />
              <span className="text-brand-600">in CAD.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="outline" size="lg" asChild>
                <Link href="/ca">Back to Canada Home</Link>
              </Button>
            </div>
          </div>
        </div>
                  ...
                  <Card key={item.id} className="relative group hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent className="text-center">
                        ...
                        {item.packageFrom && (
                          <div className="mb-2">
                            ...
                            <span className="text-2xl font-bold text-gray-900">
                              {formatPrice(item.packageFrom, 'CAD')}
                            </span>
                          </div>
                        )}
                        {item.monthlyFrom && (
                          <div className="mb-2">
                            <span className="text-3xl font-bold text-gray-900">
                              {formatPrice(item.monthlyFrom, 'CAD')}
                            </span>
                      ...
                      <Button className="w-full" asChild>
                        <Link href={`/contact?country=ca&service=${item.id}`}>
                          Get Started
                        </Link>
                      </Button>
                    </CardContent>
                  ...
                  <Card key={item.id} className="relative group hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent className="text-center">
                      ...
                      <Button className="w-full bg-purple-600 hover:bg-purple-700" asChild>
                        <Link href={`/contact?country=ca&service=creative&type=${item.id}`}>
                          Get Started
                        </Link>
                      </Button>
                    </CardContent>
        ...
        <div className="container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" variant="secondary" asChild>
              <Link href="/contact?country=ca">Get a Free Consultation</Link>
            </Button>
